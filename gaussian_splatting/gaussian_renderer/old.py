...
def render(
    ...
    # seg = pc.get_segmentation
    # if mask is not None:
    #     rendered_features, radii, depth, opacity = rasterizer(
    #         means3D=means3D[mask],
    #         means2D=means2D[mask],
    #         shs=None,
    #         colors_precomp=seg[mask],
    #         opacities=opacity[mask],
    #         scales=scales[mask],
    #         rotations=rotations[mask],
    #         cov3D_precomp=cov3D_precomp[mask] if cov3D_precomp is not None else None,
    ...
    #     rendered_features, radii, depth, opacity, n_touched = rasterizer(
    #         means3D=means3D,
    #         means2D=means2D,
    #         shs=None,
    #         colors_precomp=seg,
